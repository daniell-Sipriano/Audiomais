cole esse texto no linux

cat > /home/pi/udp_stream.py << 'EOF'
import subprocess, socket, threading, queue, sys, time

ESP32_IPS   = ["10.30.30.199"]   # adicione mais IPs aqui para mais ESP32s
ESP32_PORT  = 9999
RADIO_URL   = "http://a1rj.streams.com.br:7801/stream"
SAMPLE_RATE = 48000
CHANNELS    = 2
PACKET_SIZE = 960
APLAY_DEV   = "plughw:1,0"
INTERVAL    = PACKET_SIZE / (SAMPLE_RATE * CHANNELS * 2)  # 5ms
